...
******************************************************************************/
int main(void) {
    string dTypes[] = { "dolarOficial", "dolarBlue", "dolarCCL", "dolarTurista" };  //Nombre de los diferentes tipos de dolar
    double dPrices[] = { 89.5,155.0,142.3,147.7 };     //Precios al 04/01/2021 ordenados como dTypes
    string query[] = { DOFICIAL, DBLUE, DCCL, DTURISTA } ;  //Array con los link para obtener los precios del dolar
...
******************************************************************************/
    ...
    getchar();  //Para que no termine el programa
